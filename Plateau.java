...
public class Plateau {
  ...
  remplirCases();
	...
	public static void main(String[] args) {
		...
		reglette[5]= "E";
		reglette[6]= "";
		RemplChev Regle = new RemplChev(reglette);
		...
		System.out.println(SacJeton.AffChev(a,b));
		String c = "<html>Q  <font size = 5><sub>8</sub></font><br /></html>";
		SacJeton.AffichageToLettre(c);*/
		
		CaseCourante case0 = new CaseCourante(2,3,"LT","S",1);
		CaseCourante case1 = new CaseCourante(2,4,"","U",1);
		CaseCourante case2 = new CaseCourante(2,5,"MD","K",10);
		CaseCourante case3 = new CaseCourante(2,5,"LD","E",1);
		CaseCourante case4 = new CaseCourante(2,5,"","F",4);
		CaseCourante case5 = new CaseCourante(2,5,"","G",2);
		CaseCourante case6 = new CaseCourante(2,5,"LD","",0);
		
		CaseCourante[] coup= new CaseCourante[7] ;
		coup[0]=case0;
		coup[1]=case1;
		coup[2]=case2;
		coup[3]= case3;
		...
		coup[5]=case5;
		coup[6]=case6;
		/*System.out.println(coup.get(0).valeur);
		System.out.println(coup.get(1).colonne);*/
		System.out.println(EvalCoup.SommeLettres(coup));
		System.out.println(EvalCoup.ScoreMot(coup));
		
		ArrayList <CaseCourante[]> coup1 = new ArrayList <CaseCourante[]>();
		CaseCourante[] a = {case0,case1,case2,case3};
		CaseCourante[] b = {case4,case5,case6};
		CaseCourante[] c = {case0,case1,case2,case3,case4,case5,case6};
		coup1.add(a);
		coup1.add(b);
		coup1.add(c);
		
		EvalCoup EvalCoup1 = new EvalCoup(coup1);
		/*EvalCoup1.mots=coup1;*/
		System.out.println(EvalCoup1.ScoreCoup());
